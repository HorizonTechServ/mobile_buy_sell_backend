...
public class DashboardController {
    ...
    @GetMapping("/buying")
    @Operation(summary = "Get All Bought Products", description = "Fetches all products added in the buy list")
    public ResponseEntity<StandardResponse<List<BuyingDto>>> getAllBoughtProducts() {
        String method = "getAllBoughtProducts";
        LOGGER.infoLog(CLASSNAME, method, "Fetching all bought products");

        List<BuyingDto> list = dashboardService.getAllBoughtProducts();
    ...
    @GetMapping("/selling")
    @Operation(summary = "Get All Sold Products", description = "Fetches all products listed as sold")
    public ResponseEntity<StandardResponse<List<SellingDto>>> getAllSoldProducts() {
        String method = "getAllSoldProducts";
        LOGGER.infoLog(CLASSNAME, method, "Fetching all sold products");

        List<SellingDto> list = dashboardService.getAllSoldProducts();
    ...
    @Operation(summary = "Get Sell Summary with Profit", description = "Fetch sold product details along with profit info")
    public ResponseEntity<StandardResponse<List<DashboardSellInfoDto>>> getSellSummaryWithProfit() {
        ...
        LOGGER.infoLog(CLASSNAME, method, "Fetching selling summary with profit");

        List<DashboardSellInfoDto> summaryList = dashboardService.getSellInfoSummaryWithProfit();
